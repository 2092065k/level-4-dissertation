...
Apache Spark is one of the latest big data processing frameworks which implements the cluster computing model. Its primary advantage over Hadoop is that it can perform in-memory data processing, while Map-Reduce persists all outputs back to disk a map or reduce action. 

TODO: apache spark intro

TODO: parallel operations - programming model

(shorter section here - large expanse in the RDD section)
