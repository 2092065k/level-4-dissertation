...
In regards to the API for the RDD based implementation of standard K-Means, MLlib exposes only a few methods the user needs to interact with the system.
