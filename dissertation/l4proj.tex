...
\begin{figure}[H]
	\centering
    \label{partitions2}
    \includegraphics[width=0.65\textwidth]{images/partitions2}
...
\begin{figure}[H]
	\centering
    \label{minMaxgraph}
    \includegraphics[width=0.65\textwidth]{images/Graph5}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.65\textwidth]{images/Graph4}
...
% TODO: both would need to explain evaluation methods
% TODO: make a reference to the used training data
